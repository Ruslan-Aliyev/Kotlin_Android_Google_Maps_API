...
// 1 draws a light blue dot on the user’s location.
...
// 2
    ...
    private fun placeMarkerOnMap(location: LatLng) {
        ...
        //custom pin, not googles default red pin
        markerOptions.icon(
    ...
    private fun getAddress(latLng: LatLng): String {
        ...
        try {
            // 2 Get place name from lat/lng
            addresses = geocoder.getFromLocation(latLng.latitude, latLng.longitude, 1)
            // 3 Get place name from lat/lng
